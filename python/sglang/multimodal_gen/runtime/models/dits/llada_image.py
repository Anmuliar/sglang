...
class LLaDAImageTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if self.modulation:
            ...
            if (
                _is_cuda
                and attention_output.is_cuda
                and attention_output.shape[-1] % 256 == 0
                and attention_output.shape[-1] <= 8192
                ...
                hidden_states, ffn_input = fused_norm_tanh_mul_add_norm_scale(
